    ...
    <nav class="navbar">
        <div class="nav-menu">
            ...
            <ul class="nav-list">
                ...
                <li><a href="/Funcionarios/index" <?php if($nome_controller=="Funcionarios" && $nome_action=="index") echo "style='background-color:#95bb87'";?> class="nav-link">Funcionários</a></li>
